...
readme:
	eza --long --tree --level 4 -I tools --no-permissions --no-filesize --no-user --no-time --git-ignore | svgbob --scale 1.5 --font-size 21 --font-family 'courier new' --background transparent > assets/structure.svg
